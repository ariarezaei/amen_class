...
[features, givenA, givenB] = get_predefined_sets();
time_brute = [];
time_cont_greedy = [];
time_disc_greedy = [];
...
fpath = 'C:\Users\ariar\Desktop\Research\reports\april 29\figs\simple';
...
plot(features, cont_greedy_ratio, '-bo', features, disc_greedy_ratio, '-gs',...
    features, simplified_form_ratio, '-r+', features, lazy_greedy_ratio, '-kd');
...
plot(features,worst_cont_diff, '-bo',features,worst_disc_diff, '-gs',...
    features, worst_simplified_form_diff, '-r+', features, worst_lazy_diff, '-kd');
...
plot(features, brute_score_vector, '-mx', features,cont_greedy_score_vector, '-bo',...
    ...
    features, lazy_greedy_score_vector, '-kd')
...
plot(features, cont_greedy_set_jaccard_difference, '-bo', features, disc_greedy_set_jaccard_difference, '-gs',...
    features, simplified_form_set_jaccard_difference, '-r+', features, lazy_greedy_set_jaccard_difference, '-kd')
...
plot(features, cont_greedy_set_F1_difference, '-bo', features, disc_greedy_set_F1_difference, '-gs',...
    features, simplified_form_set_F1_difference, '-r+', features, lazy_greedy_set_F1_difference, '-kd')
...
plot(features, cont_greedy_first_num, '-bo', features, disc_greedy_first_num, '-gs',...
    features, simplified_form_first_num, '-r+', features, lazy_greedy_first_num, '-kd',...
...
plot(features, cont_greedy_second_num, '-bo', features, disc_greedy_second_num, '-gs',...
    features, simplified_form_second_num, '-r+', features, lazy_greedy_second_num, '-kd',...
