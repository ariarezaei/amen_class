function [ave_rank, var_rank] = stat_stabilityAll(Xs, part, feats, new_label, exp_num )
...
for exp = 1:exp_num
    ...
    count = fprintf('Stability Experiment %d/%d', exp, exp_num);
